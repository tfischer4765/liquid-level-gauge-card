...
// Every language file here must also be listed below, otherwise it ships in the
// bundle but silently falls back to English -- which is what happened to da and hu.
